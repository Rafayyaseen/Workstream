            ...
            <NavDropdown title={<img id="img2" src={dropimage} alt="Dropdown Icon" />} id="basic-nav-dropdown">
                    <div className="custom-dropdown">
                        <div className="column">
                            <NavDropdown.Item href="#action/1.1"> <img src={listentool} alt="listentool" className="action-icon" /><p id="nav-p1">ListenTool</p></NavDropdown.Item>
                            ...
                            <NavDropdown.Item href="#action/1.3"><img src={arbisoftses} alt="arbisoft session logo" className="action-icon" /><p id="nav-p">Arbisoft Sessio...</p></NavDropdown.Item>
                            <NavDropdown.Item href="#action/1.4"><img src={holidays} alt="holidays" className="action-icon" /><p id="nav-p1">Holidays</p></NavDropdown.Item>
                        ...
                        <div className="column">
                            ...
                            <NavDropdown.Item href="#action/2.2"><img src={hirestream} alt="hirestream" className="action-icon" /><p id="nav-p">Hirestream</p></NavDropdown.Item>
                        ...
                        <div className="column">
                            ...
                            <NavDropdown.Item href="#action/3.2"><img src={lunchmenu} alt="lunchmenu" className="action-icon" /><p id="nav-p">Lunch Menu</p></NavDropdown.Item>
                            <NavDropdown.Item href="#action/3.3"><img src={checkinapp} alt="checkinapp" className="action-icon" /><p id="nav-p">Check -In App</p></NavDropdown.Item>
